...
**Notes :** The following instructions are for observing at L-band with the ROACH1
in real-time folding mode. The observed bandwidth is limited to 128
MHz and corresponds to 1332-1460 MHz (the LEAP band).
